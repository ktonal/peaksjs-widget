...
# -*- coding: utf-8 -*-
#
# peaksjs_widget documentation build configuration file
#
...
project = 'peaksjs_widget'
copyright = '2023, AntoineDaurat'
author = 'AntoineDaurat'
...
_version_py = os.path.join(repo, 'peaksjs_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'peaksjs_widgetdoc'
...
latex_documents = [
    (master_doc, 'peaksjs_widget.tex', 'peaksjs_widget Documentation',
     'AntoineDaurat', 'manual'),
]
